...
// GET Cleint Details
  ...
  // Paper trading toggle — persisted so the choice survives page reloads.
  // Returns null if never set (caller decides the default).
  bool? get isPaperTradingPref => _prefInstance?.getBool(_isPaperTradingKey);

  Future<void> setIsPaperTradingPref(bool value) async =>
      await _prefInstance!.setBool(_isPaperTradingKey, value);
}
...
const String _isPaperTradingKey = 'isPaperTrading';
