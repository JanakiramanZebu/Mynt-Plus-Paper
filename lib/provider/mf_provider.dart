...
class MFProvider extends DefaultChangeNotifier {
  ...
  final List _mfrejectsiplist = [
    {"id": "1", "reason_name": "Non availability of Funds"},
    {"id": "2", "reason_name": "Scheme not performing"},
    {"id": "3", "reason_name": "Service issue"},
    {"id": "4", "reason_name": "Load Revised"},
    {"id": "5", "reason_name": "Wish to invest in other schemes"},
    {"id": "6", "reason_name": "Change in Fund Manager"},
    {"id": "7", "reason_name": "Goal Achieved"},
    {"id": "8", "reason_name": "Not comfortable with market volatility"},
    {"id": "9", "reason_name": "Will be restarting SIP after few months"},
      ...
      try {
        ...
        try {
          ...
          if (_mfsippause?.stat == "Ok") {
            fetchmfsiplist();
            ScaffoldMessenger.of(context).showSnackBar(
                warningMessage(context, "Sip su ${_mfsippause?.msg}"));
            Navigator.pop(context);
          }
        } catch (e) {
          toggleLoadingOn(false);
