...
// import '../models/websockt_model/depth_ack.dart';
// import '../models/websockt_model/depth_update.dart';
...
//       log(":: Connecting ::");
//       channel =
//           WebSocketChannel.connect(Uri.parse("wss://go.mynt.in/NorenWSWeb/"));
...
//                 .add(TouchlineAckStream.fromJson(  res as Map<String, dynamic>));
//             // notifyListeners();
//             break;
//           case "dk":
//             log("DK ::: ${res.toString()}");
...
//                 (double.parse(_socketDatas["${res['tk']}"]["lp"]??"0.00") -
    ...
    if (!wsConnected) {
      ...
      channel.stream.listen(
        (data) {
          ...
          //     touchAcknowledgementStream.add(TouchlineAckStream.fromJson(res));
          //     // notifyListeners();
          //     break;
          //   case "dk":
          //     _
          //     fToast!.removeQueuedCustomToasts();
          //     debugPrint("Depth Scrip Acknowledgement ::: ${res.toString()}");
          //     dpAckStream.add(
          //         DepthWsAckResponse.fromJson(res as Map<String, dynamic>));
          //     break;
          //   case "df":
          //     // log("Depth Scrip Updates ::: ${res.toString()}");
          //     dpUpdateStream.add(
          //         DepthWSUpdateResponse.fromJson(res as Map<String, dynamic>));
          //     break;
          // }
          if (res['t'].toString().toLowerCase() == "tf" ||
              res['t'].toString().toLowerCase() == "df") {
