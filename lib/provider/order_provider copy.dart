...
//       BasketModel(
//           basketname: val, createdDate: curDate, max: '20', curLength: '0')
//     ];
...
//         List scipList = _bsktScrips[element.basketname] ?? [];
//         element.curLength = "${scipList.length}";
//         if (_selectedBsktName == element.basketname) {
...
// removeBasket(int index){

//   _basketName.removeAt(index);
// }
