                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextWidget.subText(
                                            text:
                                                "${ledgerprovider.caeventalldata!.bonus![index].companyName}",
                                            color: theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                      ...
                                      Padding(
                                        ...
                                        child: TextWidget.subText(
                                            ...
                                            text:
                                                "${double.tryParse(ledgerprovider.caeventalldata!.bonus![index].ratioN.toString())!.toInt()} : ${double.tryParse(ledgerprovider.caeventalldata!.bonus![index].ratioD.toString())!.toInt()}",
                                            color: Colors.black,
                                            textOverflow: TextOverflow.ellipsis,
                                            theme: theme.isDarkMode,
                                            fw: 0),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          TextWidget.subText(
                                              align: TextAlign.right,
                                              text:
                                                  " ${ledgerprovider.caeventalldata!.bonus![index].recordDate}",
                                              color: theme.isDarkMode
                                                  ? Colors.white
                                                  : Colors.black,
                                              textOverflow:
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          TextWidget.subText(
                                              align: TextAlign.right,
                                              text:
                                                  " ${ledgerprovider.caeventalldata!.bonus![index].exBonusDate}",
                                              color: theme.isDarkMode
                                                  ? Colors.white
                                                  : Colors.black,
                                              textOverflow:
