                  ...
                  : Expanded(
                      child: SingleChildScrollView(
                        child: ListView.separated(
                          ...
                          itemCount:
                              ledgerprovider.caeventalldata?.split?.length ?? 0,
                          shrinkWrap: true,
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextWidget.subText(
                                            text:
                                                "${ledgerprovider.caeventalldata!.split![index].companyName}",
                                            color: theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                      ...
                                      Padding(
                                        ...
                                        child: TextWidget.subText(
                                            ...
                                            text:
                                                "${double.tryParse(ledgerprovider.caeventalldata!.split![index].fvChangeFrom.toString())!.toInt()} : ${double.tryParse(ledgerprovider.caeventalldata!.split![index].fvChangeTo.toString())!.toInt()}",
                                            color: Colors.black,
                                            textOverflow: TextOverflow.ellipsis,
                                            theme: theme.isDarkMode,
                                            fw: 0),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text:
                                                      " ${ledgerprovider.caeventalldata!.split![index].fvChangeFrom}",
                                                  color: theme.isDarkMode
                                                      ? Colors.white
                                                      : Colors.black,
                                                  textOverflow:
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text:
                                                      " ${ledgerprovider.caeventalldata!.split![index].exDate}",
                                                  color: theme.isDarkMode
                                                      ? Colors.white
                                                      : Colors.black,
                                                  textOverflow:
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            TextWidget.subText(
                                                align: TextAlign.right,
                                                text:
                                                    " ${ledgerprovider.caeventalldata!.split![index].fvChangeTo} ",
                                                color: theme.isDarkMode
                                                    ? Colors.white
                                                    : Colors.black,
                                                textOverflow:
