...
//                       null)
//               ? double.parse(
//                   ledgerprovider.taxpnldercomcur!.data!.derivatives!.derFutPnl!)
//               : 0.00,
//           (ledgerprovider.taxpnldercomcur?.data?.derivatives != null &&
//                   ledgerprovider
...
//                       null)
//               ? double.parse(
//                   ledgerprovider.taxpnldercomcur!.data!.derivatives!.derOptPnl!)
//               : 0.00,
//         ],
//         [
//           (ledgerprovider.taxpnldercomcur?.data?.commodity != null &&
//                   ledgerprovider.taxpnldercomcur?.data?.commodity?.commFutPnl !=
//                       null)
//               ? double.parse(
//                   ledgerprovider.taxpnldercomcur!.data!.commodity!.commFutPnl!)
//               : 0.00,
//           (ledgerprovider.taxpnldercomcur?.data?.commodity != null &&
//                   ledgerprovider.taxpnldercomcur?.data?.commodity?.commOptPnl !=
//                       null)
//               ? double.parse(
//                   ledgerprovider.taxpnldercomcur!.data!.commodity!.commOptPnl!)
//               : 0.00,
