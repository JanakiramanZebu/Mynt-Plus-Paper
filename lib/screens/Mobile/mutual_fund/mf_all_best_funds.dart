...
class SaveTaxesScreen extends ConsumerStatefulWidget {
  ...
  const SaveTaxesScreen({super.key, required this.title, this.onBack});
                              ...
                              builder: (context, hoveredIndex, _) {
                                ...
                                return Row(
                                  children: [
                                    ...
                                    if (isHovered) ...[
                                      _buildActionButton('Buy', MyntColors.primary, () => _handleOrder(item, 'One-time', mf), filled: true),
                                      const SizedBox(width: 6),
                                      _buildActionButton('SIP', MyntColors.primary, () => _handleOrder(item, 'SIP', mf), filled: false),
                                    ],
                                  ],
                                );
                              },
