...
//                           Text(
//                               pref.clientName!.isNotEmpty && !pref.islogIn!
//                                   ? "Welcome to MYNT +"
//                                   : "Login to MYNT +",
//                               style: textStyle(
//                                   theme.isDarkMode
...
//                                   14,
//                                   FontWeight.w600)),
//                           if (pref.clientName!.isNotEmpty && !pref.islogIn!)
...
//                             readOnly: !pref.islogIn! &&
//                                     (pref.clientId!.isNotEmpty ||
//                                         pref.clientMob!.isNotEmpty)
//                                 ? true
//                                 : false,
//                             keyboardType: pref.isMobileLogin!
...
//                           Row(
//                             mainAxisAlignment: !pref.hideLoginOptBtn!
...
//           ],
//         ),
//         bottomNavigationBar: Container(       padding: const EdgeInsets.symmetric(horizontal: 16),
//             height: 75,
//             child: Column(
//               children: [
...
//                   style:
//                       textStyle(const Color(0xff999999), 10, FontWeight.w500),
