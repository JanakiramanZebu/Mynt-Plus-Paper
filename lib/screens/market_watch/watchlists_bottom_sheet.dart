                              ...
                              onTap: () {
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      // int selectedValue = 1;
                                      return CreatewatchList(wList: watchlist);
                                    });
                              },
                              child: Padding(
                    ...
                    return ElevatedButton(
                      onPressed: () async {
                        ...
                        if (preDefWl[index] == "My Stocks") {
                          ...
                          context.read(portfolioProvider).requestWSHoldings(
                      ...
                      child: Text(
                        ...
                        style: textStyles.prdText.copyWith(
                            color: theme.isDarkMode
                                ? Color(widget.currentWLName == preDefWl[index]
                                    ? 0xff000000
                                    : 0xffffffff)
                                : Color(widget.currentWLName == preDefWl[index]
                                    ? 0xffffffff
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                        onTap: () async {
                          ...
                          // await context
                          //     .read(marketWatchProvider)
                          //     .fetchMWScrip(watchlist[index], context);
                          ...
                          // context
                          //     .read(marketWatchProvider)
                          //     .fetchMarketWatchlistScrip(watchlist[index], context);
