...
class ChartScreenWebView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ChartScreenWebView> createState() => _ChartScreenWebViewState();
}

class _ChartScreenWebViewState extends ConsumerState<ChartScreenWebView> {
  double progress = 0;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
        (_) => ref.read(marketWatchProvider).scrollToSelectedTab(false));
  }
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, WidgetRef ref, _) {
        ...
        final chartUpdate = ref.read(chartUpdateProvider);
