...
class _ScripDepthInfoState extends ConsumerState<ScripDepthInfo>
  ...
  // IMPORTANT: initSize must always be >= 0.26 to satisfy DraggableScrollableSheet constraint
  // minChildSize = 0.25, so initialChildSize must be >= minChildSize
  ...
  double _getSafeInitialSize(double desiredSize) {
    // Ensure minSize is always > minChildSize (0.25) with proper buffer
    double minSize = 0.26;
  ...
  void _initializeSize() {
    setState(() {
      // Ensure initialChildSize is always > minChildSize (0.25) with proper buffer
                ...
                builder: (context, snapshot) {
                  ...
                  return GestureDetector(
                    ...
                    child: DraggableScrollableSheet(
                        // Ensure initialChildSize >= minChildSize (0.25)
                        // initSize is validated to be >= 0.26 before this point
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Material(
                                                                        ...
                                                                        child: InkWell(
                                                                            ...
                                                                            onTap: () async {
                                                                              await scripInfo.fetchScripInfo(depthData.token!, depthData.exch!, ctx);
                                                                              if (scripInfo.scripInfoModel!.stat == "Ok") {
                                                                      ...
                                                                      GridView.count(
                                                                          ...
                                                                          children: List.generate(scripInfo.returnsGridview.length, (index) {
                                                                            return Container(
                                                                                ...
                                                                                decoration: BoxDecoration(color: theme.isDarkMode ? colors.textSecondaryDark.withOpacity(0.3) : colors.btnBg, borderRadius: BorderRadius.circular(5)),
