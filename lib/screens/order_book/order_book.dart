...
class _OrderBookState extends State<OrderBook> {
  ...
  Widget _buildOrderList(List<OrderBookModel> items, OrderProvider order,
      ThemesProvider theme, ScopedReader watch) {
      ...
      itemBuilder: (context, index) {
        ...
        return Builder(builder: (itemContext) {
          return _OrderItem(
            ...
            theme: theme,
            onTap: () =>
                _navigateToOrderDetails(items[itemIndex], watch, itemContext),
            onLongPress: () {
  ...
  void _navigateToOrderDetails(
      OrderBookModel order, ScopedReader watch, BuildContext context) async {
    try {
      ...
      final quoteResponse = await watch(marketWatchProvider)
