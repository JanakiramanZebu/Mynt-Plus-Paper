                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                // Update order book data with WebSocket updates
                                if (socketDatas.containsKey(orderBook[itemIndex].token)) {
                                  final socketData = socketDatas[orderBook[itemIndex].token];
                                  
                                  // Only update with non-zero values
                                  final lp = socketData['lp']?.toString();
                                  if (lp != null && lp != "null" && lp != "0" && lp != "0.00") {
                                    orderBook[itemIndex].ltp = lp;
                                  }
                                  
                                  final pc = socketData['pc']?.toString();
                                  if (pc != null && pc != "null" && pc != "0" && pc != "0.00") {
                                    orderBook[itemIndex].perChange = pc;
                                  }
                                }
                          ...
                          builder: (context, snapshot) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                // Update order book data with WebSocket updates
                                if (socketDatas.containsKey(searchorder[itemIndex].token)) {
                                  final socketData = socketDatas[searchorder[itemIndex].token];
                                  
                                  // Only update with non-zero values
                                  final lp = socketData['lp']?.toString();
                                  if (lp != null && lp != "null" && lp != "0" && lp != "0.00") {
                                    searchorder[itemIndex].ltp = lp;
                                  }
                                  
                                  final pc = socketData['pc']?.toString();
                                  if (pc != null && pc != "null" && pc != "0" && pc != "0.00") {
                                    searchorder[itemIndex].perChange = pc;
                                  }
                                }
