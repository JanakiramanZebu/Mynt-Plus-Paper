        ...
        itemBuilder: (context, index, controller) {
          for (var i = 0;
            ...
            if (socketDatas.containsKey(positionBook
                    .groupedBySymbol[positionBook.groupPositionSym[index]]
                ['groupList']![i]['token'])) {
              positionBook.groupedBySymbol[positionBook.groupPositionSym[index]]
                      ['groupList']![i]['lp'] =
          ...
          return ExpandedTile(
                  ...
                  children: [
                    Text(
                        ...
                        style: textStyle(
                            ...
                            14,
                            FontWeight.w600)),
                    // if (positionBook.groupedBySymbol[
                    //         positionBook.groupPositionSym[index]]['isexit'] ==
                    //     "true")
                    //   Container(
                    ...
                    //                         content: SizedBox(width: MediaQuery.of(context).size.width, child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text("Are you sure you want to exit all positions?")])),
                    //                         actions: [
                    //                           TextButton(
                    //                               onPressed: () =>
              ...
              content: ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int ind) {
                    ...
                    //     ['groupList']![ind]['token'])) {
                    //   positionBook.groupedBySymbol[positionBook
                    //           .groupPositionSym[index]]['groupList']![ind]['lp'] =
                    ...
                    //       positionBook.isDay,
                    //       positionBook.groupedBySymbol[positionBook
                    //           .groupPositionSym[index]]['groupList']![ind]);
                    //   // });
                    // }
                    ...
                    return InkWell(
                      onTap: () async {
                        ...
                        Navigator.pushNamed(context, Routes.positionGroupDetail,
                            arguments: positionBook.groupedBySymbol[positionBook
                                .groupPositionSym[index]]['groupList']![ind]);
                      },
                      child: PositionListGrpCard(
                          groupData: positionBook.groupedBySymbol[positionBook
                              .groupPositionSym[index]]['groupList']![ind]),
                    );
                  }));
        },
