                        ...
                        showModalBottomSheet(
                          ...
                          builder: (context) => Container(
                            ...
                            child: BondOrderScreenbottomPage(
                              bondInfo:
                                  bonds.sovereignGoldBonds!.ncbSGB![index],
                            ),
                          ),
                        );
                      },
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    //  CustomExchBadge(
                                    // exch:
                                    //     bonds.sovereignGoldBonds!.ncbSGB![index].symbol!)
                                    SizedBox(
                                      height: 4,
                                    ),
                                ...
                                // bonds.sovereignGoldBonds!.ncbSGB![index].yield != ''
                                //                  ?
                                //  Column(
                                //                      crossAxisAlignment:
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                // "${bonds.sovereignGoldBonds!.ncbSGB![index].biddingStartDate!.substring(0, 2)} - ${bonds.sovereignGoldBonds!.ncbSGB![index].biddingEndDate!.substring(5, 11)}",
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        '${bonds.sovereignGoldBonds!.ncbSGB![index].biddingEndDate!.substring(5, 11)}',
                                        style: textStyle(
                                            theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      showModalBottomSheet(
                                        ...
                                        builder: (context) => Container(
                                          ...
                                          child: BondOrderScreenbottomPage(
                                            bondInfo: bonds.sovereignGoldBonds!
                                                .ncbSGB![index],
                                          ),
                                        ),
                                      );
                                    ...
                                    child: bonds.loading
                                        ...
                                        : Column(
                                            ...
                                            children: [
                                              Text(
                                                  // "Invest ₹ ${convertCurrencyINRStandard(int.parse(bonds.sovereignGoldBonds!.ncbSGB![index].minBidQuantity!))}",
