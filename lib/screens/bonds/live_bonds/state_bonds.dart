...
class StateBondsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ScopedReader watch, _) {
      ...
      return bonds.stateBonds!.ncbSDL!.isNotEmpty
          ? Column(
              ...
              children: [
                ListView.separated(
                        ...
                        showModalBottomSheet(
                          ...
                          builder: (context) => Container(
                            ...
                            child: BondOrderScreenbottomPage(
                              bondInfo: bonds.stateBonds!.ncbSDL![index],
                            ),
                          ),
                        );
                      },
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    //  CustomExchBadge(
                                    // exch:
                                    //     bonds.stateBonds!.ncbSDL![index].symbol!)
                                    SizedBox(
                                      height: 4,
                                    ),
                                ...
                                bonds.stateBonds!.ncbSDL![index].yield != ''
                                    ? Column(
                                        crossAxisAlignment:
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                // "${bonds.stateBonds!.ncbSDL![index].biddingStartDate!.substring(0, 2)} - ${bonds.stateBonds!.ncbSDL![index].biddingEndDate!.substring(5, 11)}",
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        '${bonds.stateBonds!.ncbSDL![index].biddingEndDate!.substring(5, 11)}',
                                        style: textStyle(
                                            theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: bonds.loading
                                        ...
                                        : Column(
                                            ...
                                            children: [
                                              Text(
                                                  // "Invest ₹ ${convertCurrencyINRStandard(int.parse(bonds.stateBonds!.ncbSDL![index].minBidQuantity!))}",
                  ...
                  itemCount: bonds.stateBonds!.ncbSDL!.length,
