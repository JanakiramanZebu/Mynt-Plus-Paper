...
Row(
  ...
  tabsbutton(String text, LDProvider ledgerprovider, ThemesProvider theme) {
    if ((ledgerprovider.taxpnldercomcur?.data?.derivatives?.derFutBooked !=
                null &&
            text == 'Future Closed') ||
        (ledgerprovider.taxpnldercomcur?.data?.derivatives?.derFutOpen !=
                null &&
            text == 'Future Open') ||
        (ledgerprovider.taxpnldercomcur?.data?.derivatives?.derOptBooked !=
                null &&
            text == 'Option Closed') ||
        (ledgerprovider.taxpnldercomcur?.data?.derivatives?.derOptOpen !=
                null &&
            text == 'Option Open')) {
      return Container(
          height: 35,
