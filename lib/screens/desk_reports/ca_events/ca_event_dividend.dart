...
class CAEventDividend extends StatelessWidget {
  const CAEventDividend({super.key});
        ...
        body: TransparentLoaderScreen(
          ...
          child: Column(
            ...
            children: [
              ...
              ledgerprovider.caeventalldata?.dividend?.isEmpty ?? true
                  ? Center(
                      child: Padding(
                  ...
                  : Expanded(
                      child: SingleChildScrollView(
                        child: ListView.separated(
                          ...
                          itemCount:
                               ledgerprovider.caeventalldata?.dividend?.length ??
                                  0,
                          shrinkWrap: true,
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextWidget.subText(
                                            text: "${ ledgerprovider.caeventalldata!.dividend![index].companyName}",
                                            color: theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                            textOverflow:
                                      ...
                                      Padding(
                                        ...
                                        child: TextWidget.subText(
                                            ...
                                            text: "₹${ double.tryParse(ledgerprovider.caeventalldata!.dividend![index].dividendpershare.toString())?.toInt() ?? 0}",
                                            color: Colors.black,
                                          ...
                                          Row(
                                            children: [
                                              TextWidget.subText(
                                                  ...
                                                  TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text: " ${ ledgerprovider.caeventalldata!.dividend![index].recordDate}",
                                          ...
                                          Row(
                                            children: [
                                              TextWidget.subText(
                                                  ...
                                                  TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text: " ${ ledgerprovider.caeventalldata!.dividend![index].details}",
                                                  color: theme.isDarkMode ? Colors.white : Colors.black,
                                                  textOverflow: TextOverflow.ellipsis,
                                                  theme: theme.isDarkMode,
                                                  fw: 0),
                                        ...
                                        child: Row(
                                              children: [
                                                TextWidget.subText(
                                                    ...
                                                    TextWidget.subText(
                                                    align: TextAlign.right,
                                                    text: " ${ ledgerprovider.caeventalldata!.dividend![index].exDate}",
                                                    color: theme.isDarkMode ? Colors.white : Colors.black,
                                                    textOverflow: TextOverflow.ellipsis,
                                                    theme: theme.isDarkMode,
                                                    fw: 0),
