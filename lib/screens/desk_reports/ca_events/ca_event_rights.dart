                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextWidget.subText(
                                            text: "${  ledgerprovider.caeventalldata!.rights![index].companyName}",
                                            color: theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                            textOverflow:
                                      ...
                                      Padding(
                                        ...
                                        child: TextWidget.subText(
                                            ...
                                            text: "${  double.tryParse(ledgerprovider.caeventalldata!.rights![index].ratioN.toString())!.toInt()} : ${   double.tryParse(ledgerprovider.caeventalldata!.rights![index].rationD.toString())!.toInt()}",
                                            color: Colors.black,
                                          ...
                                          Row(
                                            children: [
                                              TextWidget.subText(
                                                  ...
                                                  TextWidget.paraText(
                                                  align: TextAlign.right,
                                                  text: "${  ledgerprovider.caeventalldata!.rights![index].recordDate}",
                                          ...
                                          Row(
                                            children: [
                                              TextWidget.subText(
                                                  ...
                                                  TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text: " ${  ledgerprovider.caeventalldata!.rights![index].premiumRs}",
                                                  color: theme.isDarkMode ? Colors.white : Colors.black,
                                                  textOverflow: TextOverflow.ellipsis,
                                                  theme: theme.isDarkMode,
                                                  fw: 0),
                                        ...
                                        child: Row(
                                              children: [
                                                TextWidget.subText(
                                                    ...
                                                    TextWidget.paraText(
                                                    align: TextAlign.right,
                                                    text: "${  ledgerprovider.caeventalldata!.rights![index].exRightsDate}",
                                                    color: theme.isDarkMode ? Colors.white : Colors.black,
                                                    textOverflow: TextOverflow.ellipsis,
                                                    theme: theme.isDarkMode,
                                                    fw: 0),
