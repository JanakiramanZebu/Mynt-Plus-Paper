                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: TextWidget.subText(
                                            text:
                                                "${ledgerprovider.caeventalldata!.dividend![index].companyName}",
                                            color: theme.isDarkMode
                                                ? colors.colorWhite
                                                : colors.colorBlack,
                                      ...
                                      Padding(
                                        ...
                                        child: TextWidget.subText(
                                            ...
                                            text:
                                                "₹${double.tryParse(ledgerprovider.caeventalldata!.dividend![index].dividendpershare.toString())?.toInt() ?? 0}",
                                            color: Colors.black,
                                            textOverflow: TextOverflow.ellipsis,
                                            theme: theme.isDarkMode,
                                            fw: 0),
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text:
                                                      " ${ledgerprovider.caeventalldata!.dividend![index].recordDate}",
                                                  color: theme.isDarkMode
                                                      ? Colors.white
                                                      : Colors.black,
                                                  textOverflow:
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              TextWidget.subText(
                                                  align: TextAlign.right,
                                                  text:
                                                      " ${ledgerprovider.caeventalldata!.dividend![index].details}",
                                                  color: theme.isDarkMode
                                                      ? Colors.white
                                                      : Colors.black,
                                                  textOverflow:
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            TextWidget.subText(
                                                align: TextAlign.right,
                                                text:
                                                    " ${ledgerprovider.caeventalldata!.dividend![index].exDate}",
                                                color: theme.isDarkMode
                                                    ? Colors.white
                                                    : Colors.black,
                                                textOverflow:
