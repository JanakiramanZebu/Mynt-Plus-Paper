...
class TaxCharges extends StatefulWidget {
  ...
  @override
  State<TaxCharges> createState() => _TaxCharges();
}

class _TaxCharges extends State<TaxCharges> {
  @override
  void initState() {
    setState(() {});
    super.initState();
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(
                        left: 16, right: 16, bottom: 14, top: 6.0),
                    child: Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  headingstat(
                    theme,
                    "FNO",
                    (ledgerprovider.taxpnldercomcur?.data?.charges
                                ?.derChargesTotal !=
                            null)
                        ? double.parse(ledgerprovider.taxpnldercomcur!.data!
                                .charges!.derChargesTotal!)
                            .toStringAsFixed(2)
                        : "0.00",
                  ),
                  Padding(
