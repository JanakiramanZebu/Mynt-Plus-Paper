...
class IosFundScreen extends StatefulWidget {
  final TranctionProvider fundIos;
  const IosFundScreen({super.key, required this.fundIos});

  @override
  _IosFundScreenState createState() => _IosFundScreenState();
}

class _IosFundScreenState extends State<IosFundScreen> {
  int _selectedIndex = -1;
  int _upiSelectedIndex = -1;
  int intValue = 0;
  int indexss = 0;
                          ...
                          children: [
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) {
                                  if (upiApps.isNotEmpty) {
                                    upiApps[indexss]['value'] == '0'
                                        ? _upiSelectedIndex = 0
                                        : upiApps[indexss]['value'] == '1'
                                            ? _upiSelectedIndex = 1
                                            : _upiSelectedIndex = 2;
                                  } else {
                                    _selectedIndex = 0;
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () {
                                    //launch(upiApps[index]['url']!);
                                    setState(() {
                                      _upiSelectedIndex = int.parse(
                                              upiApps[index]['value']
                                                  .toString())
                                          .toInt();
                                      _focusNode.unfocus();
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        // ListTile(
                                        //   title:
                                        //       Text(availableApps[index]['name']!),
                                        //   onTap: () {
                                        //     launch(availableApps[index]['url']!);
                                        //   },
                                        // ),
                                      ],
                                    ),
