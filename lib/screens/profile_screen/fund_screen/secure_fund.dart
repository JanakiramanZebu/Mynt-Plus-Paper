...
class SecureFund extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    final funds = watch(fundProvider);    final theme = watch(themeProvider);
        ...
        children: [
          if (funds.fundDetailModel?.avlMrg != "0.00") ...[
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: const Color(0xff6eb94b), width: 12)),
                height: 230,
          ...
          Container(
            decoration:   BoxDecoration(
                ...
                border: Border(
                    bottom: BorderSide(color:  theme.isDarkMode?colors.darkColorDivider:colors.colorDivider, width: 6))),
            ...
            Divider(color:  theme.isDarkMode?colors.darkColorDivider:colors.colorDivider, thickness: 1.2),
                  ListView.separated(
                    shrinkWrap: true,
                        ...
                        children: [
                          ...
                          Text(
                              getFormatter(
                                  ...
                                  v4d: false,
                                  noDecimal: false),
                              style: textStyle( theme.isDarkMode?colors.colorWhite:colors.colorBlack, 13,
                                  FontWeight.w500)),
                        ],
                      );
                    },
              ...
              children: [
                    ...
                    Row(
                      children: [
                        Row(
                          children: [
                           Icon(Icons.circle,
                                color:theme.isDarkMode?colors.colorWhite:colors.colorBlack, size: 16),
                            Text(" Margin Used ",
                ...
                if (funds.listOfUsedMrgn.isNotEmpty) ...[
                 Divider(color:  theme.isDarkMode?colors.darkColorDivider:colors.colorDivider, thickness: 1.2),
                  ...
                  Divider(color:  theme.isDarkMode?colors.darkColorDivider:colors.colorDivider, thickness: 2),
                  Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Column(
          ...
          if (funds.fundDetailModel!.pendordval != null)
            Container(
              decoration:   BoxDecoration(
                  ...
                  border: Border(
                      bottom: BorderSide(color: theme.isDarkMode?colors.darkGrey: const Color(0xffF1F3F8), width: 6))),
              padding: const EdgeInsets.all(16),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                    getFormatter(
                        value: double.parse("${funds.fundDetailModel?.avlMrg}"),
                        v4d: false,
                        noDecimal: false),
                    style:
