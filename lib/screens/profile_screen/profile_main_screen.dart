              ...
              child: ListView(
                  ...
                  children: [
                    ...
                    Divider(
                        ...
                        thickness: 0.6,
                        height: 0),
                    productList('Mutual Fund', "Invest in experts managed portfolio.",
                        "assets/profileimage/prd-mf.svg", theme, () async {
                                      ...
                                      onSelected: (isSelected) async {
                                        ...
                                        if (chips[index] == "profile") {
                                          ...
                                          Navigator.pushNamed(
                                              ...
                                              arguments: "holding");
                                        } else if (chips[index] == "profile & loss") {
                                          Navigator.pushNamed(
                                              context, Routes.reportWebViewApp,
                                              arguments: "pnl");
                                        ...
                                        } else if (chips[index] == "corporate action") {
                                          Navigator.pushNamed(
                                              context, Routes.reportWebViewApp,
                    ...
                    Row(
                      children: [
                        ServiceCard(
                            ...
                            actiontype: true,
                            action: () async {
                              await context.read(userProfileProvider).fetchsetting();
                              await context.read(apikeyprovider).fetchapikey(context);
