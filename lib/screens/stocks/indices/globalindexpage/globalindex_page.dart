...
//   final GlobalIndicesModel globalindexpage;
//   const GlobalIndexPage({
//     super.key,
//     required this.globalindexpage,
//   });

//   @override
//   State<GlobalIndexPage> createState() => _GlobalIndexPageState();
// }

// class _GlobalIndexPageState extends State<GlobalIndexPage> {
//   @override
...
//                   child: Image.network(
//                     "${widget.globalindexpage.flagUrl}",
//                     width: 30,
//                   ),
//                 ),
//                 title: Text(
//                   '${widget.globalindexpage.name}'.toUpperCase(),
//                   style: GoogleFonts.inter(
...
//                   child: Row(
//                     children: [
//                       Text('₹${widget.globalindexpage.price}',
//                           style: GoogleFonts.inter(
...
//                       ),
//                       Text(
//                           '${widget.globalindexpage.high} (${widget.globalindexpage.percentChange}%)',
//                           style: GoogleFonts.inter(
//                               textStyle: textStyle(
//                                   '${widget.globalindexpage.high}'
//                                               .toString()
//                                               .startsWith("-") ||
//                                           '${widget.globalindexpage.percentChange}'
//                                               .toString()
//                                               .startsWith("-")
