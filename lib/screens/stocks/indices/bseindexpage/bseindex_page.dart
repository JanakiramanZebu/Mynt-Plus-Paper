...
// class BseIndexPage extends StatefulWidget {
//   final BSE bseindexpage;
//   const BseIndexPage({
//     super.key,
//     required this.bseindexpage,
//   });

//   @override
//   State<BseIndexPage> createState() => _BseIndexPageState();
// }

// class _BseIndexPageState extends State<BseIndexPage> {
//   @override
...
//                     )),
//                 title: Text(
//                   '${widget.bseindexpage.idxname}'.toUpperCase(),
//                   style: GoogleFonts.inter(
...
//                       ),
//                       Text(
//                           '${widget.bseindexpage.change} (${widget.bseindexpage.change}%)',
//                           style: GoogleFonts.inter(
//                               textStyle: textStyle(
//                                   '${widget.bseindexpage.change}'
//                                               .toString()
//                                               .startsWith("-") ||
//                                           '${widget.bseindexpage.change}'
//                                               .toString()
