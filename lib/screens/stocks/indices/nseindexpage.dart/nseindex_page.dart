...
// class NseIndexPage extends StatefulWidget {
//   final NSE nseindexpage;
//   const NseIndexPage({
//     super.key,
//     required this.nseindexpage,
//   });

//   @override
//   State<NseIndexPage> createState() => _NseIndexPageState();
// }

// class _NseIndexPageState extends State<NseIndexPage> {
//   @override
...
//                 title: Text(
//                   '${widget.nseindexpage.idxname}'.toUpperCase(),
//                   style: GoogleFonts.inter(
...
//                       ),
//                       Text(
//                           '${widget.nseindexpage.change} (${widget.nseindexpage.change}%)',
//                           style: GoogleFonts.inter(
//                               textStyle: textStyle(
//                                   '${widget.nseindexpage.change}'
//                                               .toString()
//                                               .startsWith("-") ||
//                                           '${widget.nseindexpage.change}'
//                                               .toString()
