...
class PortfolioBulk extends StatefulWidget {
  const PortfolioBulk({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PortfolioBulkState createState() => _PortfolioBulkState();
}

class _PortfolioBulkState extends State<PortfolioBulk> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                SvgPicture.asset(
                                    'assets/icon/Group 1000004999.svg'),
                                const SizedBox(
                                  width: 6,
                                ),
                                Text(
