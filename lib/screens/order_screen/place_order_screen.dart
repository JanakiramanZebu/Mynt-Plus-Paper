...
//   bool isAmo = false;
  ...
  void initState() {
    ...
    setState(() {
      ...
      validityType = isUserOrderPreferenceAvailable && userOrderPreference['validity'] == 'IOC' ? 'IOC'
          : widget.orderArg.exchange == "BSE" || widget.orderArg.exchange == "BFO" ? "EOS" : "DAY";

      isAdvancedOptionClicked = _addValidityAndDisclosedQty = isUserOrderPreferenceAvailable && userOrderPreference['validity'] == 'IOC' ? true : false;
                                                  ...
                                                  if (orderType == "SIP") {
                                                    ...
                                                    setState(() {
                                                      if (frezQty == 0) {
                                                        ...
                                                        quantity =
                                                            int.parse(qtyCtrl.text.isEmpty ? "0" : qtyCtrl.text) ~/
                                                                frezQty;
                                                      }
                                                      reminder = int.parse(qtyCtrl.text.isEmpty ? "0" : qtyCtrl.text) -
                                                          (frezQty * quantity);
                                                        ...
                                                        if (isBuy!) {
                                                          if (priceType == "SL MKT") {
                                                            if (double.parse(triggerPriceCtrl.text) <
                                                              ...
                                                              if ((int.parse(
                                                                          qtyCtrl.text.isEmpty ? "0" : qtyCtrl.text) >
                                                                      frezQty &&
