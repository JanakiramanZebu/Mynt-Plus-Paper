...
class MainSmeListCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    .where((ipo) => ipostartdate(ipo.biddingStartDate, ipo.biddingEndDate) == "Open")
    .toList();

List<dynamic> preOpenIpos = mainstreamipo.mainsme
    .where((ipo) => ipostartdate(ipo.biddingStartDate, ipo.biddingEndDate) == "Pre-open")
    .toList();
      ...
      ((openIpos.isEmpty) && (ipos.ipoPreClose!.msg.isEmpty) && (preOpenIpos.isEmpty))
                            ...
                            Column(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text("${openIpos[index].totalsub}x",
                                            style: textStyle(
                                                theme.isDarkMode
                                                    ? colors.colorWhite
                                                    : colors.colorBlack,
                                    ...
                                    //               "${openIpos[index].biddingEndDate}"),
                                    //           style: textStyle(
                                    //               Color(ipostartdate("${openIpos[index].biddingStartDate}", "${openIpos[index].biddingEndDate}") == "Open" ? 0xff43A833 : 0xffB37702),
                                    //               11,
                                    //               FontWeight.w500))),
                                  ],
                                ),
                            ...
                            // SizedBox(width: 8),
                             ...
                             Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                borderRadius:
                                                    BorderRadius.circular(4)),
                                            child: Text("${preOpenIpos[index].key}",
                                                style: textStyle(
                                                    const Color(0xff666666),
                                                    10,
                                                    FontWeight.w500))),
                                   ...
                                   ,
                                    ...
                                    //               "${preOpenIpos[index].biddingEndDate}"),
                                    //           style: textStyle(
                                    //               Color(ipostartdate("${preOpenIpos[index].biddingStartDate}", "${preOpenIpos[index].biddingEndDate}") == "Open" ? 0xff43A833 : 0xffB37702),
                                    //               11,
                                    //               FontWeight.w500))),
                                  ],
                                ),
