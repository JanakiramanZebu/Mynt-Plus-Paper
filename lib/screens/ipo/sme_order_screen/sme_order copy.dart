                                    ...
                                    setState(() {
                                      ...
                                      for(final bid in addIpo){
                                        ...
                                        bid.qualityerrortext =
                                            "Maximum investment upto 1 ₹${double.parse(ipo.maxUPIAmt.toString()).toInt()} only ";
                                        ischecked = false;
                                      } else if (bid
                                              .bidpricecontroller
                                              .text
                                      ...
                                      // else if ((int.parse(bid.qualityController.text)) >
                                      //     int.parse(widget.smeipo.maxbidqty.toString())
                                      //         .toInt()) {
                                      //   ScaffoldMessenger.of(context)
                                      //       .showSnackBar(warningMessage(
                                      //           context,
                                      //           "Maximum Bid quantity is ${widget.smeipo.maxbidqty.toString()} only "));
                                      //   ischecked = false;
                                      // } 
                                      else if (bid
                                              .qualityController
                                      ...
                                      //         double.parse(widget.smeipo.maxPrice.toString())
                                      //             .toInt() ||
                                      //     (int.parse(bid.bidpricecontroller.text).toInt()) <
                                      //         double.parse(widget.smeipo.minPrice.toString()).toInt()) {
                                      //   ScaffoldMessenger.of(context)
                                      //       .showSnackBar(warningMessage(
                                      //           context,
                                      //           "Your bit price ranges between ₹${double.parse(widget.smeipo.minPrice!).toInt()} ₹${double.parse(widget.smeipo.maxPrice!).toInt()}"));
                                      ...
                                      //               : "*Bid Price Value is required"));
                                      //   ischecked = false;
                                      // } else if ((int.parse(addIpo[addIpo.length - 1].bidpricecontroller.text)) > double.parse(widget.smeipo.maxPrice.toString()).toInt() ||
