        ...
        builder: (context, watch, child) {
          ...
          return Scaffold(
                                    ...
                                    setState(() {
                                      ...
                                      if (addIpo[addIpo.length - 1].requriedprice >
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(warningMessage(
                                                context,
                                                "Your bit price ranges between ₹${double.parse(widget.mainstream.minPrice!).toInt()}-₹${double.parse(widget.mainstream.maxPrice!).toInt()}"));
                                        ischecked = false;
                                      } else if (addIpo[addIpo.length - 1]
                                              .qualityController
                                              .text
              ...
              bottomSheet: BottomAppBar(
                  elevation: .14,
                  child: timevalidation(
                              widget.mainstream.dailyStartTime.toString(),
                              widget.mainstream.dailyEndTime.toString()) ==
                          "OPEN"
                      ? Container(
                          decoration: BoxDecoration(
                              border: Border(
                                  top: BorderSide(
                                      color: colors.darkColorDivider))),
                          child: ListTile(
                            title: Text(
