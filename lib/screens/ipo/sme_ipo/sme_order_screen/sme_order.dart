...
class _SMEApplyIpoScreenState extends State<SMEApplyIpoScreen> {
  ...
  void addNewItem() {
    setState(() {
      addIpo.add(IpoDetails(
          ...
          bidprice: "${widget.smeipo.minPrice!.toInt()}",
          lotsize: int.parse("${widget.smeipo.lotSize}"),
          requriedprice: mininv(widget.smeipo.minPrice!.toDouble(),
                  widget.smeipo.minBidQuantity!.toInt())
              .toInt(),
          isChecked: false));
    });
  }
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                  "₹${widget.smeipo.minPrice!.toInt()}- ₹${widget.smeipo.maxPrice!.toInt()}",
                                  style: textStyle(const Color(0xff000000), 14,
                                      FontWeight.w500)),
                              Text("Price Range",
                                  style: textStyle(const Color(0xff666666), 12,
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                  "₹${getFormatter(value: widget.smeipo.issueSize!.toDouble(), v4d: false, noDecimal: true)}",
                                  style: textStyle(const Color(0xff000000), 14,
                                      FontWeight.w500)),
                              Text("IPO Size",
                                  style: textStyle(const Color(0xff666666), 12,
              ...
              //         style: textStyle(colors.colorBlack, 13, FontWeight.w500)),
              //     items: ipo
              //         .addDividerSubCategory(ipo.ipoCategory.toSet().toList()),
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  ...
                                  addIpo[index].isChecked == true
                                      ? addIpo[index].requriedprice =
                                          widget.smeipo.maxPrice!.toInt() *
                                              (int.parse(addIpo[index]
                                                  .qualityController
                                                  .text))
                                      : addIpo[index].requriedprice =
                                          widget.smeipo.minPrice!.toInt() *
                                              (int.parse(addIpo[index]
                                                  .qualityController
                                                  .text));
                                  if (addIpo[index]
  ...
  ipoplaceorder(FundProvider upiid) async {
    MenuData menudata = MenuData(
      ...
      category: widget.smeipo.issueType.toString(),
