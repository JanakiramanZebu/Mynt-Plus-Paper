  ...
  Widget build(BuildContext context, ScopedReader watch) {
    ...
    return Column(
      children: [
        ...
        //             ),
        //             child: Text(
        //               '${ipos.smeIpoModel?.sMEIPO?.length ?? 0}',
        //               style: textStyle(colors.colorWhite, 9, FontWeight.w500),
        //             ),
        //           ),
        //         ),
        //       ]),
        ...
        Column(
          children: [
            ipos.smeIpoModel?.msg == "no IPO found"
                ? Container()
                : ListView.separated(
                    shrinkWrap: true,
                        ...
                        children: [
                          ListTile(
                            title: Row(
                              ...
                              children: [
                                Text("${ipos.smeIpoModel?.sMEIPO?[index].name}",
                                    style: textStyle(
                                        theme.isDarkMode
                                            ? colors.colorWhite
                                            : colors.colorBlack,
