...
import 'best_mf_screens/mf_all_best_funds.dart';
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    ...
    return Scaffold(
        ...
        body: TransparentLoaderScreen(
          isLoading: mfData.mfloader == true,
          child: ListView(
            ...
            children: [
              ...
              mfData.bestmfselected.isEmpty
                  ? Container()
                  : const SaveTaxesScreen(),
              Text(
                  mfData.bestmfselected.isNotEmpty
                      ? ""
                  ...
                  style: textStyle(
                      ...
                      16,
                      FontWeight.w600)),
              mfData.bestmfselected.isEmpty ? const MfCategory() : Container(),
              mfData.bestmfselected.isEmpty
