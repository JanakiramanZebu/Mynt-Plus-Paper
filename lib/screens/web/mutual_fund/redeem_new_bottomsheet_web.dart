...
class RedemptionBottomScreenNewWeb extends StatefulWidget {
  const RedemptionBottomScreenNewWeb({super.key});

  @override
  State<RedemptionBottomScreenNewWeb> createState() =>
      _RedemptionBottomScreenNewWebState();
}

class _RedemptionBottomScreenNewWebState extends State<RedemptionBottomScreenNewWeb> {
  var ischecked = false;
