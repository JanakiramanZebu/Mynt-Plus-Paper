...
import 'package:mynt_plus/screens/web/mutual_fund/mf_cancel_sip_alert_web.dart';
import 'package:mynt_plus/screens/web/mutual_fund/mf_timeline_web.dart';
...
class mfSipdetScrenWeb extends StatefulWidget {
  ...
  const mfSipdetScrenWeb({super.key, this.data});
  @override
  State<mfSipdetScrenWeb> createState() => _mfSipdetScrenWeb();
}

class _mfSipdetScrenWeb extends State<mfSipdetScrenWeb>
