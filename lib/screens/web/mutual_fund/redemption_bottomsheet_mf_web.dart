...
class RedemptionBottomScreenWeb extends ConsumerStatefulWidget {
  final MFHoldingsModel mfHoldingData;
// , required this.bondInfo
  const RedemptionBottomScreenWeb({super.key, required this.mfHoldingData});

  @override
  ConsumerState<RedemptionBottomScreenWeb> createState() => _RedemptionBottomScreenState();
}

class _RedemptionBottomScreenState extends ConsumerState<RedemptionBottomScreenWeb> {
