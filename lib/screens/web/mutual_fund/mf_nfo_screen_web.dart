...
class MFNFOScreenWeb extends ConsumerStatefulWidget {
  final VoidCallback? onBack;
  const MFNFOScreenWeb({super.key, this.onBack});

  @override
  ConsumerState<MFNFOScreenWeb> createState() => _MFNFOScreenWebState();
}

class _MFNFOScreenWebState extends ConsumerState<MFNFOScreenWeb> {
      ...
      builder: (context) => Dialog(
        ...
        child: SizedBox(
          ...
          child: ClipRRect(
            ...
            child: MFOrderScreenWeb(mfData: nfoItem),
          ),
        ),
      ),
    );
