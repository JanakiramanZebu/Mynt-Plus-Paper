...
import '../bonds_orderbook_details/open_order_details_web.dart';

class BondsOpenOrderListWeb extends StatelessWidget {
  final List<dynamic> orders;
  final ThemesProvider theme;
  const BondsOpenOrderListWeb({super.key, required this.orders, required this.theme});
...
class _OrderItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   _navigateToDetails(BuildContext context) {
    ...
    return BondsOpenOrderDetailsWeb(bondsdetails: order);
    // Navigator.pushNamed(
    //   context,
