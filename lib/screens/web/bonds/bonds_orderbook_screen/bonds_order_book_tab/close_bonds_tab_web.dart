...
import '../bonds_orderbook_details/close_order_details_web.dart';
import '../../../../../res/global_state_text.dart';

class BondsCloseOrderListWeb extends StatelessWidget {
  final List<dynamic> orders;
  final ThemesProvider theme;
  const BondsCloseOrderListWeb({super.key, required this.orders, required this.theme});
...
class _OrderItem extends StatelessWidget {
  ...
  _navigateToDetails(BuildContext context) {
    return BondsCloseOrderDetailsWeb(bondsCloseDetails: order);
  }
}
