...
import 'package:mynt_plus/screens/web/bonds/live_bonds/bonds_table_web.dart';
import 'package:mynt_plus/screens/web/bonds/live_bonds/govt_bonds_web.dart';
import 'package:mynt_plus/screens/web/bonds/live_bonds/sovereign_gold_bonds_web.dart';
import 'package:mynt_plus/screens/web/bonds/live_bonds/state_bonds_web.dart';
import 'package:mynt_plus/screens/web/bonds/live_bonds/treasury_bonds_web.dart';
...
class BondsListScreenWeb extends StatelessWidget {
  const BondsListScreenWeb({super.key});
    ...
    return Consumer(builder: (context, WidgetRef ref, _) {
      ...
      return LayoutBuilder(
        builder: (context, constraints) {
          ...
          // Table handles empty state internally with NoDataFound inside table body
  ...
  Widget _buildContentMobile(BondsProvider bonds, double devHeight, WidgetRef ref) {
    ...
    return const Column(
      children: [
        GovtBondsScreenWeb(),
        TreasuryBondsScreenWeb(),
        StateBondsScreenWeb(),
        SovereignGoldBondsScreenWeb(),
      ],
    );
  }
  ...
  Widget _buildSearchResults(BondsProvider bonds, double devHeight) {
    ...
    return Column(
      children: [
        if (hasGovtBonds) const GovtBondsScreenWeb(),
        if (hasTreasuryBonds) const TreasuryBondsScreenWeb(),
        if (hasStateBonds) const StateBondsScreenWeb(),
        if (hasSovereignBonds) const SovereignGoldBondsScreenWeb(),
