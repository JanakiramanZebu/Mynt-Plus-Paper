...
class StateBondsScreenWeb extends StatefulWidget {
  const StateBondsScreenWeb({super.key});

  @override
  State<StateBondsScreenWeb> createState() => _StateBondsScreenWebState();
}

class _StateBondsScreenWebState extends State<StateBondsScreenWeb> {
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, WidgetRef ref, _) {
      ...
      if (bonds.stateBonds?.ncbSDL?.isEmpty ?? true) {
  ...
  Widget _buildBondsList(BuildContext context, BondsProvider bonds,
    ...
    List<dynamic> filteredBonds = stateBonds;
    if (ref.watch(stocksProvide).searchController.text.isNotEmpty) {
      filteredBonds = stateBonds
