...
class BondOrderScreenbottomPageWeb extends ConsumerStatefulWidget {
  final BondsList bondInfo;

  const BondOrderScreenbottomPageWeb({super.key, required this.bondInfo});

  @override
  ConsumerState<BondOrderScreenbottomPageWeb> createState() =>
      _BondOrderScreenbottomPageState();
}

class _BondOrderScreenbottomPageState
    extends ConsumerState<BondOrderScreenbottomPageWeb> {
