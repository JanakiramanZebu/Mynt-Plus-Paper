...
//   bool isAmo = false;
                      ...
                      Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                final isSelected = orderType == orderTypes[index]['type'];
                                return Padding(
                                  ...
                                  child: MouseRegion(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        } else if (orderTypes[index]['type'] ==
                                            "Intraday") {
                                          orderInput.chngInvesType(
                                              InvestType.intraday, "PlcOrder");
                                        } else if (orderTypes[index]['type'] ==
                                            "MTF") {
                                          orderInput.chngInvesType(
                                                              ...
                                                              onTap: () {
                                                                setState(() {
                                                                  orderInput.setGTTPriceTypeOrderIsMarket(
                                                                      !orderInput
                                                                          .GTTPriceTypeOrderIsMarket);
                                                                  final newType = orderInput
                                                                          .GTTPriceTypeOrderIsMarket
                                                                      ? "Market"
                                                                      : "Limit";
                                                                  orderInput
                                                                ...
                                                                onTap: () {
                                                                  setState(() {
                                                                    orderInput.setGTTOCOPriceTypeOrderIsMarket(
                                                                        !orderInput
                                                                            .GTTOCOPriceTypeOrderIsMarket);
                                                                    final newType1 = orderInput
                                                                            .GTTOCOPriceTypeOrderIsMarket
                                                                        ? "Market"
                                                                        : "Limit";
                                                                    orderInput
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () {
                                                  final profileDetails = ref.watch(
                                                              ...
                                                              onTap: () {
                                                                setState(() {
                                                                  if (_isStock) {
                                                                    ...
                                                                    if (_isQtyToAmount) {
                                                                      qtyCtrl
                                                                          .text = ((double.tryParse(widget.orderArg.ltp ?? "0.00") ?? 0)
                                                                              .ceil())
                                                                          .toString();
                                                                    } else {
                                                                      qtyCtrl.text =
                    ...
                    child: CustomTextFormField(
                        ...
                        onChanged: (value) {
                          ...
                          if (value.isNotEmpty && value != "0") {
                            ...
                            ResponsiveSnackBar.showWarning(context, "Trigger cannot be 0");
                          } else {
                            ResponsiveSnackBar.showWarning(context, "Trigger cannot be empty");
                          }
                        },
              ...
              child: Semantics(
                ...
                child: CustomTextFormField(
                    ...
                    onChanged: (value) {
                      ...
                      if (value.isEmpty) {
                        ResponsiveSnackBar.showWarning(context, "Target cannot be empty");
              ...
              child: Semantics(
                ...
                child: CustomTextFormField(
                    ...
                    onChanged: (value) {
                      ...
                      if (value.isEmpty) {
                        ResponsiveSnackBar.showWarning(context, "Stoploss cannot be empty");
                      } else if (value.isNotEmpty && double.parse(value) <= 0) {
                        ResponsiveSnackBar.showWarning(context, "Stoploss cannot be 0");
                      }
                    },
                    hintText: "0.00",
                    hintStyle: TextWidget.textStyle(
    ...
    if (widget.isBasket == "Basket" ||
      ...
      if (!isSliceOrd) {
        ...
        int q = ((int.parse(getFinalQuantity(qtyCtrl.text)) / lotSize).round() *
            lotSize);
        if (int.parse(getFinalQuantity(qtyCtrl.text)) != q &&
        ...
        if (placeorder) {
          ...
          PlaceOrderInput placeOrderInput = PlaceOrderInput(
              ...
              qty: widget.scripInfo.exch == 'MCX'
                  ? (int.parse(getFinalQuantity(qtyCtrl.text)) * lotSize)
                      .toString()
  ...
  void marginUpdate() {
    OrderMarginInput input = OrderMarginInput(
        ...
        qty: widget.scripInfo.exch == 'MCX'
            ? (double.parse(getFinalQuantity(qtyCtrl.text)).toInt() * lotSize)
                .toString()
            : getFinalQuantity(qtyCtrl.text),
        rorgprc: '0',
        rorgqty: '0',
    ...
    for (int splitQty in splitQuantities) {
      scripList.add({
        ...
        "trgprc": priceType == "SL Limit" || priceType == "SL MKT"
            ? triggerPriceCtrl.text
            : "",
        "tsym": widget.scripInfo.tsym != null
            ? UrlUtils.encodeParameter(widget.scripInfo.tsym!)
            : '',
        "mktProt": priceType == "Market" || priceType == "SL MKT"
            ? mktProtCtrl.text
            : ''
