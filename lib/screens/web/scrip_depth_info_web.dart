...
import '../market_watch/scrip_detail_dialogue.dart';
import '../market_watch/set_alert_screen.dart';
                                             ...
                                             children: [
                                               ...
                                               Material(
                                                 ...
                                                 child: InkWell(
                                                     ...
                                                     onTap: () async {
                                                       await scripInfo.fetchScripInfo(depthData.token!, depthData.exch!, context);
                                               ...
                                               onTap:
                                                 ...
                                                 if (mounted) {
                                                  ...
                                                  if (kIsWeb && WebNavigationHelper.isAvailable) {
                                                    WebNavigationHelper.navigateTo("optionChain", arguments: widget.wlValue);
                                                  } else {
                                                    await Navigator.pushNamed(
                                                        context,
                                                        Routes.optionChain,
