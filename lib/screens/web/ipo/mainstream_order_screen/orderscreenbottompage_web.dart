...
import '../IPO_order_screen/ipo_order_screen_web.dart' show PaymentDialogWrapper;
...
class _OrderScreenbottomPage extends ConsumerState<OrderScreenbottomPage> {
                          ...
                          ? ipo.loading
                              ...
                              : () {
                                  if (upiid.upiid.text.isEmpty) {
                                    ...
                                    ipoplaceorder(upiid, ipo, context);
                                  }
                                }
                          : () {},
                      child: ipo.loading
  ...
  ipoplaceorder(TranctionProvider upiid, IPOProvider ipo, BuildContext context) async {
